...
df = pd.read_csv("unique_table_for20.csv")
...
df['buy_price'] = df.apply(get_buy_price,axis=1)
...
df['buy_rate'] = (df['buy_price'] - df['close'])/df['close']*100
...
df['pro'] = df.apply(calculate_profit,axis=1)
